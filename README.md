...
A longer-form post can be found on the [Substack](https://shitwolfymakes.substack.com/p/matrix256-a-pressing-level-disc-fingerprint) announcement.
...
All implementations must produce byte-identical digests on the same input view; cross-implementation parity is verified against [`CONFORMANCE_FIXTURES.md`](CONFORMANCE_FIXTURES.md). 
